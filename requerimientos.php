...
function cargar(){
        ...
        <?php 
            ...
            $query = "SELECT modulo, requerimientos, noResueltos FROM requerimientos ORDER BY modulo ASC";
...
function densidad(n){
    ...
    var cc = c.toFixed(2);
    if(c > 100){
        alert("El # de requerimientos no resueltos debe ser menor que el # de requerimientos");
    }
    else{
	//grandPromedios[n] = c;
...
function funcion(){
        ...
        for (var i = 1; i <= n; i++) {
            ...
            if(checkbox){
                ///////////////////////////////////////////////////////////////////////////
                var modulo=i;   
                var requerimientos=$("#a"+i).val();
                var noResueltos=$("#b"+i).val();
                

                $.post("requerimientos_db.php",{"modulo":modulo, "requerimientos":requerimientos, "noResueltos":noResueltos});
                ///////////////////////////////////////////////////////////////////////
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    title:{
        text: "% de requerimientos no resueltos por modulos"
    },
    axisX: {
      title: "Numero de modulo"
    },
    axisY: {
        title: "% de requerimientos no resueltos",
        includeZero: true,
        valueFormatString: "",
        suffix: "",
        stripLines: [   
...
<div style="float:right"><b>Entidad:</b> Cosas Recibidas o usadas - <b>Atributo:</b> Requerimientos </div>
<input type="button" style="float:left;" class="btn btn-success" id="Volver" value="Volver Atrás" onclick="volver();">

<body>
<div class="container">
    <h1>Requerimientos no resueltos</h1><hr>
    <h4>Este formulario permite visualizar el comportamiento del porcentaje de requerimientos no resueltos en cada módulo o unidad de trabajo.  </h4>
    <h4><b>1.</b> Utilicé el botón <b>+</b> para ingresar cada modulo.</h4>
    <h4><b>2.</b> Ingrese el número de requerimientos total por módulo.</h4>
    <h4><b>3.</b> Ingrese el número de requerimientos no resueltos en dicho módulo.</h4>
    <h4><b>5.</b> El campo CL se calcula dividiendo el total de # de requerimientos no resueltos entre el total de # de requerimientos.</h4>
   ...
   <hr>
    ...
    <div class="row">
        ...
        <div class="col-md-2"><label># de requerimientos</label></div>
        <div class="col-md-2"><label># de requerimientos no resueltos</label></div>
        <div class="col-md-2"><label>% de requerimientos no resueltos</label></div>
    ...
    <div class="row" id="fila"></div>
    <br><hr>
    <div><label>Total de # de requerimientos</label></div>
    <div  id= "sumA"> : </div><br>
    <div><label>Total de # de requerimientos no resueltos</label></div>
    <div  id= "sumB"> : </div>
