...
function addRow(){
        ...
        div.setAttribute('class', 'form-inline');
            div.innerHTML = '<div style="clear:both"><input class="col-md-1" type="number" id="number" value="'+n+'" readonly="readonly"><input type="checkbox" id="y'+n+'" checked><input class="col-md-2" type="number" min="0" id="esfuerzo'+n+'"><input class="col-md-2" type="number" min="0" id="costo'+n+'" placeholder="$" step="1000" onchange="calcularCosto('+n+')"><div class="col-md-2" type="number" min="0" id="total'+n+'" placeholder="$" step="1000"></div>';
...
function cargar(){
        ...
        <?php 
            ...
            $query = "SELECT proceso, esfuerzo, costo FROM costo ORDER BY proceso ASC";
         ...
         ?>
            ...
            var esfuerzo = '<?php echo $esfuerzo;?>'
            var costo = '<?php echo $costo;?>'
            

            var div = document.createElement('div');
        div.setAttribute('class', 'form-inline');
            div.innerHTML = '<div style="clear:both"><input class="col-md-1" type="number" id="number" value="'+proceso+'" readonly="readonly"><input type="checkbox" id="y'+n+'" checked><input class="col-md-2" type="number" min="0" id="esfuerzo'+n+'" value="'+esfuerzo+'"><input class="col-md-2" type="number" min="0" id="costo'+n+'" value="'+costo+'" placeholder="$" step="1000" onchange="calcularCosto('+n+')"><div class="col-md-2" type="number" min="0" id="total'+n+'" placeholder="$" step="1000"></div>';
            document.getElementById('fila').appendChild(div);document.getElementById('fila').appendChild(div);
...
function calcularCosto(n){
    var esfuerzo = document.getElementById("esfuerzo"+n).value;
    var costo = document.getElementById("costo"+n).value;
    var total = esfuerzo*costo;
    document.getElementById("total"+n).innerHTML=total; 
...
function funcion(){
        ...
        for (var i = 1; i <= n; i++) {
            ...
            if(checkbox){
                ...
                ///////////////////////////////////////////////////////////////////////////
                var proceso=i;   
                var esfuerzo=$("#esfuerzo"+i).val();
                var costo=$("#costo"+i).val();
                

                $.post("dinero_db.php",{"proceso":proceso, "esfuerzo":esfuerzo, "costo":costo});
                ///////////////////////////////////////////////////////////////////////
                var valor = parseFloat(document.getElementById("total"+i).innerHTML);
        ...
        for (var i = 1; i < n; i++) {
            var y = i + 1;
            var a = parseFloat(document.getElementById("total"+y).innerHTML);
            var b = parseFloat(document.getElementById("total"+i).innerHTML);
            var mr = Math.abs(a - b);
            grandRangos.push(mr);
            sumaR = sumaR + mr;
        }
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    title:{
        text: "Grafica de costo por proceso"
    },
    axisX: {
      title: "Proceso"
    },
...
<div style="float:right"><b>Entidad:</b> Cosas consumidas - <b>Atributo:</b> Dinero</div>
<input type="button" style="float:left;" class="btn btn-success" id="Volver" value="Volver Atrás" onclick="volver();">

<body>
<div class="container">
    <h1>Costo de un proceso o tarea</h1><hr>
    <h4>Este formulario permite visualizar el comportamiento del costo de un proceso o tarea.  </h4>
    <h4><b>1.</b> Utilicé el botón <b>+</b> para ingresar cada proceso o tarea.</h4>
    <h4><b>2.</b> Ingrese el costo de cada proceso o tarea.</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-2"><label>Esfuerzo (horas)</label></div>
        <div class="col-md-2"><label>Costo por hora</label></div>
        <div class="col-md-2"><label>Costo Total</label></div>
