...
<html>
<head>
<title>Esfuerzo por dias - Horas de reunión</title>
...
<body>
<div class="container">
    <h1>Esfuerzo por días - Horas de reunión</h1><hr>
    <h4>Este formulario permite visualizar el comportamiento de las horas de reunión utilizadas en un proceso de software
     cada DÍA.  </h4>
    <h4><b>1.</b> Utilicé el botón <b>+</b> para ingresar cada día.</h4>
    <h4><b>2.</b> Ingrese el número de horas de reunión utilizadas en cada día.</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-1"><label>Horas de reunión</label></div>
