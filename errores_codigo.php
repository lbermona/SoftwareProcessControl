...
<html>
<head>
<title>Errores en el codigo</title>
...
function addRow(){
        ...
        div.setAttribute('class', 'form-inline');
            div.innerHTML = '<div style="clear:both"><input class="col-md-1" type="number" id="number" value="'+n+'" readonly="readonly"><input class="col-md-1" type="number" min="0" id="a'+n+'" ><input class="col-md-1" type="number" min="0" id="b'+n+'" onchange="densidad('+n+');"><input type="checkbox" id="y'+n+'" checked><div class="col-md-1" type="number" min="0" id="c'+n+'" ></div>';
...
function cargar(){
        ...
        <?php 
            ...
            $query = "SELECT modulo, defectos, tamano FROM errores ORDER BY modulo ASC";
         ...
         ?>
            ...
            var defectos = '<?php echo $defectos;?>'
            var tamano = '<?php echo $tamano;?>'
            

            var div = document.createElement('div');
        div.setAttribute('class', 'form-inline');
            div.innerHTML = '<div style="clear:both"><input class="col-md-1" type="number" id="number" value="'+n+'" readonly="readonly"><input class="col-md-1" type="number" min="0" id="a'+n+'" value="'+defectos+'"><input class="col-md-1" type="number" min="0" id="b'+n+'" value="'+tamano+'" onchange="densidad('+n+');"><input type="checkbox" id="y'+n+'" checked><div class="col-md-1" type="number" min="0" id="c'+n+'" ></div>';
            document.getElementById('fila').appendChild(div);document.getElementById('fila').appendChild(div);
...
function densidad(n){
	...
	arreglo.push(b);
	sumB = sumB + b;
	var c = Math.ceil10((a*1000)/b, -1);
    var cc = c.toFixed(2);
    if(a > b){
        alert("El # de defectos debe ser menor que el tamaño del modulo");
    }
    else{
	//grandPromedios.push(c);
    //grandPromedios[n] = c;
...
function funcion(){
        ...
        for (var i = 1; i <= n; i++) {
            ...
            if(checkbox){
                ...
                ///////////////////////////////////////////////////////////////////////////
                var modulo=i;   
                var defectos=$("#a"+i).val();
                var tamano=$("#b"+i).val();
                

                $.post("errores_codigo_db.php",{"modulo":modulo, "defectos":defectos, "tamano":tamano});
                ///////////////////////////////////////////////////////////////////////
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    title:{
        text: "Defectos por modulos"
    },
    axisX: {
      title: "Numero de modulo"
    },
    axisY: {
        title: "Defectos/KSLOC",
        includeZero: false,
        valueFormatString: "",
        suffix: "",
        stripLines: [   
...

    {
		...
		markerSize: 2,
		dataPoints: [
					{x: 1, y: puntosLCL[0], indexLabel: "LCL"},
                    {x: 2, y: puntosLCL[1]},
                    {x: 3, y: puntosLCL[2]},
                    {x: 4, y: puntosLCL[3]},
                    {x: 5, y: puntosLCL[4]},
...
<div style="float:right"><b>Entidad:</b> Cosas Producidas - <b>Atributo:</b> Problemas y defectos</div>
<input type="button" style="float:left;" class="btn btn-success" id="Volver" value="Volver Atrás" onclick="volver();">

<body>
<div class="container">
    <h1>Densidad de los defectos por módulo</h1><hr>
    <h4>Este formulario permite visualizar el comportamiento de la densidad de los defectos por cada 1000 líneas de código en cada módulo o unidad de trabajo.  </h4>
    <h4><b>1.</b> Utilicé el botón <b>+</b> para ingresar cada modulo.</h4>
    <h4><b>2.</b> Ingrese el número de errores de codigo o defectos encontrados en dicho módulo.</h4>
    <h4><b>3.</b> Ingrese el tamaño del módulo en líneas de código (SLOC).</h4>
    <h4><b>4.</b> La columna densidad de defectos se calcula por cada 1000 líneas de código automáticamente.</h4>
    <h4><b>5.</b> El campo CL se calcula dividiendo el total de # de defectos entre el total del tamaño de módulos.</h4>
   ...
   <hr>
    ...
    <div class="row">
        ...
        <div class="col-md-1"><label># de defectos</label></div>
        <div class="col-md-1"><label>Tamaño del modulo</label></div>
        <div class="col-md-1"><label>Densidad de defectos</label></div>
    ...
    <div class="row" id="fila"></div>
    <br><hr>
    <div><label>Total de # de defectos</label></div>
    <div  id= "sumA"> : </div><br>
    <div><label>Total del tamaño de modulos</label></div>
    <div  id= "sumB"> : </div>
